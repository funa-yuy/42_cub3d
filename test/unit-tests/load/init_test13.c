...
/*   Updated: 2025/06/21 14:59:45 by miyuu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
map/correct/before_id_space.cub
...
int	init_test13(void)
{
	...
	target = &(t_data){\
		...
		5, 6, /* height,width */\
		{.y = 3, .x = 4, .angle = 3.0f * M_PI / 2.0f}, map};/*player, map*/
	printf("\x1b[32m ================ ↓正解↓ ================ \x1b[39m\n");
	debug_print_data((t_data *)target);

	printf("\x1b[32m ================ ↓自作↓ ================= \x1b[39m\n");
	input_string = "map/correct/before_id_space.cub";
